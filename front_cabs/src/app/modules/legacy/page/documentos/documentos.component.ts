  ...
  template: `
    <div class="bg-white min-h-screen p-6 md:p-10 font-sans">
      <div class="max-w-7xl mx-auto">
        ...
        <!-- Título -->
        <h1 class="placeholder-title">Catálogo de documentos</h1>
        
        <!-- Contenido de la página -->
        <div class="placeholder-content">
          <p class="api-endpoint">API Endpoint: <strong>GET /api/documentos</strong></p>
          <p>
            Aquí iría tu componente real para mostrar la tabla (datagrid) 
            con la información de los almacenes (VwdocumentosCompletas).
          </p>
