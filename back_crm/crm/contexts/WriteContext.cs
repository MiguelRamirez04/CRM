...

{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrdenTrabajo>(entity =>
        {
            ...
            entity.Property(e => e.CitaProgramadaInicio).HasColumnName("cita_programada_inicio").HasColumnType("timestamp");
            entity.Property(e => e.CitaProgramadaFin).HasColumnName("cita_programada_fin").HasColumnType("timestamp");
            ...
            entity.Property(e => e.UbicacionText).HasColumnName("ubicacion_text").HasColumnType("text");
            ...
            entity.Property(e => e.CreadoEn).HasColumnName("creado_en").HasColumnType("timestamp").IsRequired().HasDefaultValueSql("now()");
            entity.Property(e => e.ActualizadoEn).HasColumnName("actualizado_en").HasColumnType("timestamp");
        ...
        modelBuilder.Entity<Reparacion>(entity =>
        {
            ...
            entity.Property(e => e.FechaLlegada).HasColumnName("fecha_llegada").HasColumnType("timestamp").IsRequired();
            entity.Property(e => e.EmpezadoEn).HasColumnName("empezado_en").HasColumnType("timestamp");
            entity.Property(e => e.EntregadoEn).HasColumnName("entregado_en").HasColumnType("timestamp");
        ...
        modelBuilder.Entity<EjecucionOrden>(entity =>
        {
            ...
            entity.Property(e => e.TecnicoId).HasColumnName("tecnico_id").IsRequired();
            entity.Property(e => e.HrInicio).HasColumnName("hr_inicio").HasColumnType("timestamp");
            entity.Property(e => e.HrFin).HasColumnName("hr_fin").HasColumnType("timestamp");
            entity.Property(e => e.Comentarios).HasColumnName("comentarios").HasColumnType("text");
