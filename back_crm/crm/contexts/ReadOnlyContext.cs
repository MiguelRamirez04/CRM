...
public class ReadOnlyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwNumerosSerieCompletos>(entity =>
        {
            ...
            entity.Property(e => e.NumeroSerie).HasColumnType("text");
            ...
            entity.Property(e => e.FechaTimestamp).HasColumnType("timestamp");
            entity.Property(e => e.Activo).HasColumnType("boolean");
