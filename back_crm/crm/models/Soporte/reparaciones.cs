...
namespace back_cabs.CRM.models.Soporte
{
    ...
    public class Reparacion
    {
        ...
        */
        ...
        [Column("descripcion_falla", TypeName = "text")]
        public string DescripcionFalla { get; set; } = string.Empty;

        /// <summary>
        /// Diagnóstico realizado por el técnico.
        /// </summary>
        [Column("diagnostico", TypeName = "text")] // Changed to NVARCHAR(MAX)
        public string? Diagnostico { get; set; }

        /// <summary>
        /// Descripción de la solución aplicada al dispositivo.
        /// </summary>
        [Column("solucion_aplicada", TypeName = "text")] // Changed to NVARCHAR(MAX)
        ...
        /// </summary>
        [Column("causa_irreparable", TypeName = "text")]
        ...
        /// </summary>
        [Column("notas", TypeName = "text")] // Changed to NVARCHAR(MAX)
